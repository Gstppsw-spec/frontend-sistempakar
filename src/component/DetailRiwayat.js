  ...
  return (
    <div>
      ...
      <div className="body-cont-riwayat">
        <h1 style={{ color: "white" }}>HALAMAN DETAIL RIWAYAT DIAGNOSA</h1>
      </div>
      <main className="body-hasil">
        ...
        <div className="user-info">
          <h4>Kesimpulan</h4>
          <span>
            Berdasarkan gejala yang terpilih anda didprediksi mengalami Depresi
            sedang dengan tingkat keyakinan sebesar 80%
          </span>
          <hr></hr>
        </div>
        <div className="user-info">
